      ...
      <div className="flex-grow">
        <section className="border-b border-border bg-background">
          <div className="page-container-narrow">
            ...
            <h1 className="mt-4 text-4xl font-bold text-foreground md:text-5xl">Terms of Service</h1>
            <p className="mt-5 max-w-3xl text-lg text-muted-foreground">
              These terms govern your use of Privexio.com and outline general conditions for engaging with Privexio.
            </p>
